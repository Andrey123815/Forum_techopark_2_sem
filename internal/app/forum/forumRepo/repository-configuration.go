...
type ForumRepository interface {
	...
	GetThreadsBySlug(forumSlug string, limit int, desc bool, since string) ([]models.Thread, error)
	...
	GetForumUsers(forumID int64, limit int, desc string, since string) ([]models.User, error)
}
